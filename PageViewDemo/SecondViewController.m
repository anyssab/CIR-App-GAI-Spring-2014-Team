...
- (void)viewDidLoad
{
    ...
    _pageImages = @[@"liv1.jpg", @"liv2.jpg", @"liv3.jpg", @"liv4.jpg", @"liv5.jpg", @"liv6.jpg", @"liv7.jpg", @"liv8.jpg", @"liv9.jpg"];
...
{
    if([[segue identifier] isEqualToString:@"secondResult"])
    {
        AppDelegate *app = (AppDelegate *)[[UIApplication sharedApplication] delegate];
        NSMutableDictionary *results = [app results];
        [results setValue: [NSNumber numberWithInt:_currentPage] forKey:@"second"];
    }
}
